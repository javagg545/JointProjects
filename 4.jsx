...
import Link from "http://localhost:3000"
        ...
        <div key="1" className="flex flex-col min-h-[100vh]">
            <header className="px-4 lg:px-6 h-14 flex items-center">
                ...
                <nav className="ml-auto flex gap-4 sm:gap-6">
                    ...
                    <Link href="#">
                        <a className="text-sm font-medium hover:underline underline-offset-4">Materials</a>
                    </Link>
                    <Link href="#">
                        <a className="text-sm font-medium hover:underline underline-offset-4">Testimonials</a>
                    </Link>
                    <Link href="#">
